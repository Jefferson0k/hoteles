...
class StoreBranchRoomTypePriceRequest extends FormRequest
{
    ...
    public function withValidator($validator)
    {
        $validator->after(function ($validator) {
            ...
            $exists = \App\Models\BranchRoomTypePrice::where('sub_branch_id', $this->sub_branch_id)
                ->where('room_type_id', $this->room_type_id)
                ->where('rate_type_id', $this->rate_type_id)
                ->where(function ($query) {
                    $query->where(function ($q) {
                        // La nueva fecha de inicio cae dentro de un rango existente
                    ...
                    ->orWhere(function ($q) {
                        // La nueva fecha de fin cae dentro de un rango existente
